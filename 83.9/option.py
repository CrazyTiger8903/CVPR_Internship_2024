...
parser.add_argument('--lr', type=str, default='[5e-3]*15000', help='Learning rates for steps (list form)')
parser.add_argument('--alpha', type=float, default=5e-4, help='Weight for RTFM loss')
...
parser.add_argument('--emb_folder', type=str, default='sent_emb_n3', help='Folder for text embeddings, used to differentiate different swinbert pretrained models')
